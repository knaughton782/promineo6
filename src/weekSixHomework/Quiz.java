...
public class Quiz {
	 ...
	 *  	Test Driven Development: The main idea is to write the tests before writing the code
	 *  	so that all the code meets the standards of the the test. Its supposed to create clean,
	 *  	efficient code, and eliminate the amount of bugs in your code. The concept is not about
	 *  	the testing process but about improving the quality and design of the code from the start.
	 */
	
	/* 42. When would you use an interface?
	 *  	An interface is used when you know what your program should do or look like, but not how
	 *  	to do it. This allows you to maintain the contract, and also at the same time, allow the 
	 *  	classes or methods implementing the interface to use it in the way they need.
	 */
	...
	//Will and I worked on this together and this was as close as we could figure. Suggestions and 
	//feedback WELCOME!!
